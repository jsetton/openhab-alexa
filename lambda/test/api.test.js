...
describe('API Gateway Tests', () => {
  ...
  describe('auth token', () => {
    ...
    it('refresh token grant type', async () => {
      // set environment
    ...
    it('user token grant type', async () => {
      // set environment
    ...
    it('no parameters bad request error', async () => {
      // set environment
    ...
    it('invalid parameters bad request error', async () => {
      // set environment
    ...
    it('user token unauthorized error', async () => {
      // set environment
      const parameters = { grant_type: 'user_token', user_token: 'foo' };
      const request = { routeKey: 'POST /auth/token', body: JSON.stringify(parameters) };
    ...
    it('user token bad gateway error', async () => {
      // set environment
      const parameters = { grant_type: 'user_token', user_token: 'foo' };
      const request = { routeKey: 'POST /auth/token', body: JSON.stringify(parameters) };
    ...
    it('user settings not found error', async () => {
      // set environment
      const parameters = { grant_type: 'user_token', user_token: 'foo' };
      const request = { routeKey: 'POST /auth/token', body: JSON.stringify(parameters) };
      sinon.stub(OpenHAB.prototype, 'getUUID').resolves(userId);
    ...
    it('user settings internal server error', async () => {
      // set environment
      const parameters = { grant_type: 'user_token', user_token: 'foo' };
      const request = { routeKey: 'POST /auth/token', body: JSON.stringify(parameters) };
  ...
  describe('other requests', () => {
    it('not implemented error', async () => {
      // set environment
