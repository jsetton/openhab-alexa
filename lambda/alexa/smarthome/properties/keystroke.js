...
class Keystroke extends AlexaProperty {
   ...
   *  https://developer.amazon.com/en-US/docs/alexa/device-apis/alexa-keypadcontroller.html#keystroke-property
   * @return {Array}
   */
  get supportedValues() {
    return [
  ...
  isValid(properties) {
    return (
      ...
      // Valid if supported keys not empty
      this.supportedKeys.length > 0
    );
  }
